...
return [
    ...
    */
    ...
    'confirm_delete_confirm_button_text' => env('SWEET_ALERT_CONFIRM_DELETE_CONFIRM_BUTTON_TEXT', 'Ya, hapus datanya!'),
    ...
    'confirm_delete_position' => env('SWEET_ALERT_CONFIRM_POSITION', 'center')
